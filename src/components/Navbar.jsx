      ...
      <div className="w-full flex justify-between items-center max-w-9xl mx-auto">
        ...
        <ul className="list-none hidden sm:flex flex-row gap-10">
          ...
          {navLinks.map((nav) => (
            ...
            <button
              onClick={() => window.open('https://drive.google.com/file/d/1DpZhSyy6duwbQE6JZ2FgJqpiwocyCIYB/view?usp=sharing', '_blank')}
          ...
          <div className={`${!toggle ? "hidden" : "flex"} p-6 black-gradient absolute top-20 right-0 mx-4 my-2 min-w-[140px] z-10 rounded-xl`}>
            <ul className="list-none flex justify-end items-start flex-1 flex-col gap-4">
              ...
              <li className="font-poppins font-medium cursor-pointer text-[16px] ${styles.navLink} ${styles.navLinkHover}">
                <button
                  onClick={() => window.open('https://drive.google.com/file/d/1ao6zagS2VR2uIRc4WGIChnEhO9KBfEgd/view?usp=sharing', '_blank')}
